...
<input placeholder='rate' disabled value={detail.rate} name='rate' onChange={e=>setDetail({...detail,[e.target.name]:e.target.value})}></input>
<input placeholder='count' disabled value={detail.count} name='count' onChange={e=>setDetail({...detail,[e.target.name]:e.target.value})}></input>
